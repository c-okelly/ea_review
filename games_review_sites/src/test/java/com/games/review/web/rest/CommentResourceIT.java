...
import static com.games.review.web.rest.TestUtil.createFormattingConversionService;
...
//        assertThat(testComment.getDate()).isEqualTo(DEFAULT_DATE);
    ...
    @Test
    @Transactional
    public void checkDateIsNotRequired() throws Exception {
        int databaseSizeBeforeTest = commentRepository.findAll().size();
        // set the field null
        comment.setDate(null);
        // Create comment with no date
        ...
        List<Comment> commentList = commentRepository.findAll();
        assertThat(commentList).hasSize(databaseSizeBeforeTest+1);
    }
